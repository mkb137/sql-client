...
pub const DEFAULT_APPLICATION_NAME: &str = "SqlClient Data Provider";
pub const DEFAULT_ATTACH_DB_FILENAME: Option<String> = None;
pub const DEFAULT_AUTHENTICATION: SqlAuthenticationMethod = SqlAuthenticationMethod::NotSpecified;
...
pub const DEFAULT_TRANSACTION_BINDING: &str = "Implicit Unbind";
pub const DEFAULT_TRUST_SERVER_CERTIFICATE: bool = false;
pub const DEFAULT_TYPE_SYSTEM_VERSION: &str = "Latest";
